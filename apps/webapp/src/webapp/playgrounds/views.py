...
def home_view(request):
    ...
    dataset_dir = os.getenv("DATASET_DIR", "/webapp/datasets")
    ...
    return render(request, "pages/../templates/pages/playground.html", context=context)
...
def algorithm_form(request, algorithm_name):
    ...
    schema = resp.json()
    print(schema)
    return render(request, "partials/../templates/partials/algorithm_inputs.html", {"schema": schema})
